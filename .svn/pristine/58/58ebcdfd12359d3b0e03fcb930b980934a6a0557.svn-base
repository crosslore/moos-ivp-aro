...
void HazardMetric::evaluateReport(string source)
{
  ...
  unsigned int cnt_hazard_right = 0;
  unsigned int cnt_hazard_wrong = 0;
  unsigned int cnt_benign_right = 0;
  unsigned int cnt_benign_wrong = 0;
  unsigned int cnt_hazard_zilch = 0;
  unsigned int cnt_benign_zilch = 0;
  ...
  m_report_breakdown.clear();

  string msg;
  msg = "hazard_right: " + uintToString(cnt_hazard_right) + " (";
  msg += doubleToStringX(cnt_hazard_right * m_hazard_right) + ")";
  m_report_breakdown.push_back(msg);

  msg = "hazard_wrong: " + uintToString(cnt_hazard_wrong) + " (";
  msg += doubleToStringX(cnt_hazard_wrong * m_hazard_wrong) + ")";
  m_report_breakdown.push_back(msg);

  msg = "benign_right: " + uintToString(cnt_benign_right) + " (";
  msg += doubleToStringX(cnt_benign_right * m_benign_right) + ")";
  m_report_breakdown.push_back(msg);
 
  msg = "benign_wrong: " + uintToString(cnt_benign_wrong) + " (";
  msg += doubleToStringX(cnt_benign_wrong * m_benign_wrong) + ")";
  m_report_breakdown.push_back(msg);
 
  msg = "hazard_zilch: " + uintToString(cnt_hazard_zilch) + " (";
  msg += doubleToStringX(cnt_hazard_zilch * m_hazard_zilch) + ")";
  m_report_breakdown.push_back(msg);

  msg = "benign_zilch: " + uintToString(cnt_benign_zilch) + " (";
  msg += doubleToStringX(cnt_benign_zilch * m_benign_zilch) + ")";
  m_report_breakdown.push_back(msg);
...
void HazardMetric::printReport() 
{
  ...
  // Part 5: Latest Report Breakdown
  cout << endl;
  cout << "Latest Report Breakdown:                   " << endl;
  cout << "======================================     " << endl;
  unsigned int i, vsize = m_report_breakdown.size();
  for(i=0; i<vsize; i++) 
    cout << m_report_breakdown[i] << endl;
